...
class flag:
    ...
    model_file = 'models/mosaic.ckpt-done'

    image_file = "./temp/out/tmp_out.png"
...
def _main():
    ...
    with tf.Graph().as_default():
        with tf.Session().as_default() as sess:
            ...
            generated_file = './temp/out/tmp_out_2.png'
            ...
            img = cv2.imread('./temp/out/tmp_out_2.png')
            cv2.imwrite('./temp/out/tmp_out.png', img)
            os.remove('./temp/out/tmp_out_2.png')
